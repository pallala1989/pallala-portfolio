...
export const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen bg-white relative overflow-hidden pt-20">
      {/* Geometric Background Elements */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-20 left-10 w-32 h-32 gradient-orange rounded-full opacity-10 animate-float"></div>
        <div className="absolute top-40 right-20 w-24 h-24 gradient-blue rounded-full opacity-10 animate-pulse-custom" style={{ animationDelay: '1s' }}></div>
        <div className="absolute bottom-40 left-20 w-40 h-40 gradient-green rounded-full opacity-10 animate-float" style={{ animationDelay: '2s' }}></div>
        <div className="absolute bottom-20 right-10 w-28 h-28 gradient-purple rounded-full opacity-10 animate-pulse-custom" style={{ animationDelay: '0.5s' }}></div>
        
        {/* Abstract shapes */}
        <div className="absolute top-1/3 left-1/4 w-16 h-16 border-4 border-blue-200 rotate-45 animate-rotate-slow"></div>
        <div className="absolute top-2/3 right-1/3 w-12 h-12 bg-orange-200 rounded-lg animate-pulse-custom" style={{ animationDelay: '1.5s' }}></div>
      </div>
          ...
          <div className="space-y-8 animate-slide-in-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="px-8 py-4 gradient-blue text-white rounded-lg hover:shadow-lg transition-all duration-300 transform hover:scale-105 font-medium"
              >
                View My Work
              </button>
              <button
                onClick={() => scrollTo('contact')}
                className="px-8 py-4 border-2 border-blue-600 text-blue-600 rounded-lg hover:bg-blue-600 hover:text-white transition-all duration-300 font-medium"
              >
                Get In Touch
              </button>
            </div>
            ...
            <div className="relative">
              ...
              <div className="w-80 h-80 mx-auto rounded-full gradient-blue p-2 shadow-2xl">
                <div className="w-full h-full rounded-full bg-white p-2 relative overflow-hidden">
                  ...
                  <div className="absolute bottom-4 left-4 p-2 bg-green-500 rounded-full animate-bounce" style={{ animationDelay: '0.5s' }}>
                    <Users size={16} className="text-white" />
                  </div>
                  <div className="absolute top-1/2 left-4 p-2 bg-purple-500 rounded-full animate-bounce" style={{ animationDelay: '1s' }}>
